        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-white rounded-lg p-8 shadow-md border-l-4 border-l-conf-green-600">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="mb-4">
                It is planned to publish the peer-reviewed and selected papers
                of conference as proceedings with Springer. For detailed
                instructions for author and editors of conference proceedings,
                kindly visit the following link: <br />
                <a
